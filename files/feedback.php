 ...
 */
    ...
    */   
   define('CC_FB_TO_EMAIL', 'astomar@drtomar.com');
   /**
    ...
    */  
   define('CC_FB_RESULTS_REDIRECT', 'http://www.drtomar.com/images/feedback.html');
   ...
   {      
      ...
      {      
         ...
         if(CC_FB_AUTO_REPLY)
         {
            $auto_reply_msg = 'Dear Valued Investors,

Welcome to the Corporate Era Investment Agency.

I would like to congratulate you for having provisionally advanced to the C.E.I.C.C.A. Screening for Account Creation.

Thank you for showing interest in being a part of the Corporate Era- An agency whose aim is to give Financial Freedom. Your account has been set up and it will be activated within 48-72 working hours.

Once your account has been activated you can start earning as much as want. In case you are not able to access your account within the stipulated time please contact us on problem@corporateera.com

We will get back to you with your Account Details within next 72 working hours.

Assuring you of our support and best service at all times. 

Healthy Feeling

Ferdinand Belarmino
Head Of Account Dept.
Corporate Era Investment Consultancy';
